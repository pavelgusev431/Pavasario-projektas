...
export default function PublicUserProfile() {
  ...
  const productsWithComments = products.filter((product) => product.comments.length > 0);
  return (
    <>
        ...
        {productsWithComments.map((product) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="flex items-center gap-1 mt-2">
                {[...Array(5)].map((_, i) => {
                  if (i < Math.floor(product.avgRating)) {
                    ...
                    return <FaStarHalf key={i} className="text-yellow-500" />;
                  } else {
              ...
              <h4 className="mt-4 font-semibold text-lg text-gray-700">Comments</h4>
