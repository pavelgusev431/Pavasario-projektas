      ...
      {products.length > 0 ? (
        <div className="mt-6 space-y-6">
          {products.map((product) => (
            <div key={nanoid(64)} className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 p-4">
        ...
        <p className="text-center text-gray-600 mt-6">No rated products.</p>
      )}
    </section>
  );
}
