...
<div className="relative flex min-h-screen w-full bg-gray-700 overflow-hidden">
    <ToastContainer />
    <div className={`flex w-[200%] md:duration-500 md:animate-ease-in 
                ...
                <div className="flex justify-center mt-4">
                    <button
                        ...
                        className={`px-4 py-2 w-1/2 text-sm font-medium rounded-l-lg transition ${
                            authType === 'signup' ? 'bg-[#D30043] text-white' : 'bg-gray-200 hover:bg-gray-300'
                        }`}
                    >
                        Sign Up
                    </button>
                    <button
                        ...
                        className={`px-4 py-2 w-1/2 text-sm font-medium rounded-r-lg transition ${
                            authType === 'login' ? 'bg-[#D30043] text-white' : 'bg-gray-200 hover:bg-gray-300'
                        }`}
                    >
                        Login
                    </button>
    ...
    <div className={`absolute top-0 max-sm:hidden right-0 w-1/2 h-full bg-gradient-to-br from-gray-900 to-gray-700 
