...
const ProductDetails = () => {
    ...
    if (product.amount_in_stock > 5) {
        ...
        stockClass = 'text-green-500 dark:text-green-400';
    } else if (product.amount_in_stock > 0) {
        stockStatus = 'Low in stock';
        stockClass = 'text-yellow-500 dark:text-yellow-400';
    } else {
        stockStatus = 'Out of stock';
        stockClass = 'text-red-500 dark:text-red-400';
    }
    ...
    return (
        <div className="container mx-auto p-4 text-gray-800 dark:text-gray-200 bg-white dark:bg-gray-900">
            <div className="flex flex-col md:flex-row bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
                ...
                <div className="w-full md:w-1/2 p-6 md:p-8">
                    ...
                    {product.amount_in_stock > 0 && (
                        <button className="bg-red-500 dark:bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-600 dark:hover:bg-red-700 transition-colors duration-300">
                            Buy Now
                        </button>
                    )}
                </div>
            ...
            >
                <div className="bg-white dark:bg-gray-800 p-8 rounded-lg max-w-6xl mx-auto flex flex-col md:flex-row">
                    ...
                    <div className="w-full md:w-1/2 p-6 flex flex-col justify-center">
                        ...
                        <button
                            onClick={closeModal}
                            className="mt-4 bg-red-500 dark:bg-red-600 text-white px-6 py-3 rounded-md hover:bg-red-600 dark:hover:bg-red-700 transition-colors duration-300"
                        >
                            Close
                        </button>
                    </div>
